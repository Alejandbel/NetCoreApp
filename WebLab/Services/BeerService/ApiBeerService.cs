...
namespace WebLab.Services.BeerService
{
    public class ApiBeerService : IBeerService
    {
        ...
        public ApiBeerService(IHttpClientFactory httpClientFactory, [FromServices] IConfiguration config, ILogger<ApiBeerService> logger, IHttpContextAccessor httpContextAccessor)
        {
